...
Load `whatsapp-check-order.php` in the` / wp-content / plugins / `directory and activate the plugin through the 'Plugins' menu in WordPress. This can be done easily from the "Upload plugin" menu of the wordpress administrator
